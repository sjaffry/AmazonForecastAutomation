...
payload = forecastName + ' for ' + dt.strftime('%d/%m/%y') + ' is ready. Click https://us-west-2.quicksight.aws.amazon.com/sn/dashboards/3d72dce2-197e-4e88-a02a-6f043c56d8ac to view.'
